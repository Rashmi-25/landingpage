<template>
  ...
  <!--<nav class="flex items-center justify-between  bg-indigo-500 ">-->
        
        <img class="logo" src="./assets/Logo/X03.png">
          <h1 class="font-MyFont title-font lg:text-4xl text-3xl mb-8 font-bold text-gray-900 px-16 justify-between ">
       World's 1st Fluid Intelligence School
    </h1>
      ...
      <button class="flex mx-auto bg-transparent px-10 hover:bg-indigo-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-indigo-500 hover:border-transparent rounded" style="position: relative; left: 94px; top: -68px;">
       ...
       <video class="video px-8 mp4" width="1000" height="240" controls>
          <source src="./assets/video.mp4" type="video/mp4" >
          </video>

        
            <br>
            <p class="flex mx-auto font-bold text-4xl mb-8 px-20 justify-center" style="text-align:right;">Our courses include</p>
            <div class="border-t-4 br-red"></div>
      <br><br>
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
        ...
        <div class="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
            <div class=" text-white flex items-center absolute rounded-full py-4 px-4 shadow-xl bg-white left-4 -top-6">
                <!-- svg  -->
                <img src="./assets/queen.png" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                
            </div>
            <div class="mt-8">
                <p class="text-xl font-semibold my-2">Chess</p>
                <div class="border-t-2 "></div>
                <div class="flex space-x-2 text-gray-400 text-sm">
                   <p class="font-semibold text-base mb-2">
                     Give your child the chance to build strong fundamentals in Chess. Our experienced coaches have created a brand new framework across all Ranks and a new structure plan this summer to ensure that your child gets access to the best learning material.
                   </p>
               </div>
            </div>
            </div>
        ...
        <div class="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
            <div class=" text-white flex items-center absolute rounded-full py-4 px-4 shadow-xl bg-white left-4 -top-6">
                <!-- img  -->
                <img src="./assets/fintal.png" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
               
            </div>
            <div class="mt-8">
                <p class="text-xl font-semibold my-2">Fintal</p>
                <div class="border-t-2 "></div>
                <div class="flex space-x-2 text-gray-400 text-sm">
                        <p class="font-semibold text-base mb-2">Math is all pervasive with application from chess to physics to cooking. Wonder Math is an innovative program to help children appreciate problem solving through Math & puzzles. We have partnered with IXL</p>
        ...
        <div class="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
            <div class=" text-white flex items-center absolute rounded-full py-4 px-4 shadow-xl bg-white left-4 -top-6">
                <!-- svg  -->
                <img src="./assets/rubis.jpg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
            </div>
            <div class="mt-8">
                <p class="text-xl font-semibold my-2">Rubiks</p>
                <div class="border-t-2 "></div>
                <div class="flex space-x-2 text-gray-400 text-sm">
                        <p class="font-semibold text-base mb-2">A right of passage for every intellectually inclined student. Conquering the spatial complexity created by one of the simplest designs by Erno Rubik has had generations fascinated. </p>
        ...
        <div class="relative bg-white py-6 px-6 rounded-3xl w-64 my-4 shadow-xl">
            <div class=" text-white flex items-center absolute rounded-full py-4 px-4 shadow-xl bg-white left-4 -top-6">
                <!-- svg  -->
                <img src="./assets/code.png" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z" />
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z" />
                
            </div>
            <div class="mt-8">
                <p class="text-xl font-semibold my-2">Coding</p>
                <div class="border-t-2 "></div>
                <div class="flex space-x-2 text-gray-400 text-sm">
                  <p class="font-semibold text-base mb-2">The single most important skill of the 21st century is CODING. As technology makes inroads into all avenues of life, CODING is no longer the forte of only the specialized programmer or hacker.  This course is targeted towards primary & middle school students</p>  
                </div>
             ...
             <h1 class="title-font lg:text-4xl text-2xl mb-8  text-white px-16 justify-between" style="text-align:center;">
       OUR AIM THROUGH THIS SUMMERCAMP IS TO TEACH
    </h1>
    ...
    <h2 class="font-MyFont text-4xl font-bold text-center text-gray-800 mb-0">
      Features
    </h2><br>
    ...
    <div class="flex items-center flex-wrap mb-20">
      ...
      <!--Paytm-->
                <div class="container mx-auto px-2 border border-gray-200 p-6 rounded-lg">
                     <h1 class="font-MyFont title-font sm:text-4xl text-3xl mb-8 font-bold text-gray-900 px-16 justify-between ">Select The Payment Options 
        </h1>
                      ...
                      <div class="pricing-plan border-t-4 border-solid border-white bg-white text-center max-w-sm mx-auto hover:border-indigo-600 transition-colors duration-300">
                        <div class="p-6 md:py-8">
                            ...
                            <div class="relative w-24 h-24">
                                <img class="rounded-full border border-gray-100 shadow-sm" src="./assets/paytm_logo.jpg" alt="user image"/>
                                <div class="absolute top-0 right-0 h-6 w-6 my-1 border-4 border-white rounded-full bg-green-400 z-2"></div>
                                <h4 class="font-medium leading-tight text-2xl mb-2">PayTM</h4>
                        ...
                        <div class="p-6">
                            <p class="text-base mb-8 leading-relaxed px-10">You can make the payment through PayTM by clicking on the button below. Please share the transactions details through email immediately. There maybe additional transaction charges.</p>
                          <div class="mt-6 py-4">
                            <button required=" " class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-500 rounded text-lg">
                                <a href="https://paytm.com/education/Karnataka/Bengaluru/Zugzwang%20Chess%20School/Location%20(Area)/New%20Registration&utm_medium=smarturl&utm_source=smarturl&utm_term=web&utm_campaign=web" required="">PayTM Karo</a> </button>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="pricing-plan-wrap lg:w-1/3 my-4 md:my-6">
                        <div class="pricing-plan border-t-4 border-solid border-white bg-white text-center max-w-sm mx-auto hover:border-indigo-600 transition-colors duration-300">
                          <div class="p-6 md:py-8">
                              ...
                              <div class="relative w-24 h-24">
                                  <img class="rounded-full border border-gray-100 shadow-sm item-center" src="./assets/download.png" alt="user image"  />
                                  <div class="absolute top-0 right-0 h-6 w-6 my-1 border-4 border-white rounded-full bg-green-400 z-2"></div>
                                  <h4 class="font-medium leading-tight text-2xl mb-2">Paypal</h4>
                                   <div class="flex space-x-2">
                                </div>
                              </div>
                          </div>
                          ...
                          <div class="p-6">
                              <p class="text-base mb-8 leading-relaxed px-10">This option is available only for customers outside India. Those within India are requested to use other forms of payments. Please make payment after the invoice has been generated.</p>
                            <div class="mt-6 py-4">
                            
                                <button required=" " class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-500 rounded text-lg">
                                    <a href="https://www.paypal.com/paypalme/zugzwangacademy" required="">Paypal Me</a> </button>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="pricing-plan-wrap lg:w-1/3 my-4 md:my-6">
                        <div class="pricing-plan border-t-4 border-solid border-white bg-white text-center max-w-sm mx-auto hover:border-indigo-600 transition-colors duration-300">
                          <div class="p-6 md:py-8">
                              ...
                              <div class="relative w-24 h-24">
                                  <img class="rounded-full border border-gray-100 shadow-sm" src="" alt="user image"  />
                                  <div class="absolute top-0 right-0 h-6 w-6 my-1 border-4 border-white rounded-full bg-green-400 z-2"></div>
                                  <h4 class="font-medium leading-tight text-2xl mb-2">Instamojo</h4>
                                   <div class="flex space-x-2">
                                </div>
                              </div>
                          </div>
                          ...
                          <div class="p-6">
                              <p class="text-base mb-8 leading-relaxed px-10">You can make the payment through PayTM by clicking on the button below. Please share the transaction details through email immediately. There maybe additional transaction charges.</p>
                            <div class="mt-6 py-4">
                           <button required=" " class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-500 rounded text-lg">
                             <a href="https://www.instamojo.com/@zugzwang" required="">Pay Throuh Instamojo</a> </button>
                            </div>
                          </div>
                        </div>
                      </div>
    ...
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-3xl text-4xl font-medium title-font font-bold mb-4 text-indigo-500">Our Team</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-4xl">Join our Team of brilliant, excited and successful people. </p>
    </div>
    <div class="flex flex-wrap -m-2">
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border px-4 rounded-lg">
          ...
          <div class="flex-grow">
            <h2 class="text-gray-900 title-font font-medium">Bharath Divyang</h2>
      ...
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          ...
          <div class="flex-grow">
            <h2 class="text-gray-900 title-font font-medium">Vijay Kumar </h2>
      ...
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          ...
          <div class="flex-grow">
            <h2 class="text-gray-900 title-font font-medium">Sunitha</h2>
      ...
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          ...
          <div class="flex-grow">
            <h2 class="text-gray-900 title-font font-medium">Bobby</h2>
            <p class="text-gray-500">Zugdev</p>
          </div>
        </div>
      </div>
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          ...
          <div class="flex-grow">
            <h2 class="text-gray-900 title-font font-medium">vinayak Kumar</h2>
  ...
  <!--Contact-us-->
        <svg class="text-gray-100 h-10 mx-sm" fill=currentColor viewBox="0 0 150 29" version="1.1"
      ...
      <div
        ...
        <div class="flex flex-col justify-between">
          <div>
            ...
            <br>
            <div class="text-gray-700 font-semibold px-16" style="font-size:20px;">
              Fill the form
            </div>
          </div>
        ...
        <div class="">
          <div>
            ...
            <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" type="text" placeholder="" v-model.trim="submit.fullname" >
          </div>
          <div class="mt-8">
            <span class="uppercase text-sm text-gray-600 font-bold">Email</span>
            <input class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" type="text" v-model.trim="submit.email">
          </div>
          <div class="mt-8">
            <span class="uppercase text-sm text-gray-600 font-bold">Message</span>
            <textarea class="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" type="text" v-model.trim="submit.message"></textarea>
          </div>
          <div class="mt-8">
    ...
    <footer class="footer bg-gray relative pt-1 border-b-2 border-blue-700">
        ...
        <div class="mt-16 border-t-2 border-gray-300 flex flex-col items-center">
            <div class="sm:w-2/3 text-center py-6">
                <p class="text-lg text-blue-700 font-bold mb-2">
                    2012 - 2021 © ZugZwang Chess School Private Limited
                </p>
            </div>
        </div>
    </div>
